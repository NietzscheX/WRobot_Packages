...
public class Main : wManager.Plugin.IPlugin
{
    ...
    public void Initialize()
    {
		...
		robotManager.Helpful.Logging.Write("Gold Making Plugin Vanilla by Bambo is being loaded. V1.1.0");
        ClearDoNotSellList();
        EnableSelling();
    ...
    public void ClearDoNotSellList()
    {
        ...
        if (GMPVanillaSettings.CurrentSetting.farmFelcloth == 0 && wManager.wManagerSetting.CurrentSetting.DoNotSellList.Contains("Red Power Crystal"))
            {
            wManager.wManagerSetting.CurrentSetting.DoNotSellList.Remove("Red Power Crystal");
            }

        if (GMPVanillaSettings.CurrentSetting.farmFelcloth == 0 && wManager.wManagerSetting.CurrentSetting.DoNotSellList.Contains("Blue Power Crystal"))
            {
            wManager.wManagerSetting.CurrentSetting.DoNotSellList.Remove("Blue Power Crystal");
            }

        if (GMPVanillaSettings.CurrentSetting.farmFelcloth == 0 && wManager.wManagerSetting.CurrentSetting.DoNotSellList.Contains("Green Power Crystal"))
            {
            wManager.wManagerSetting.CurrentSetting.DoNotSellList.Remove("Blue Power Crystal");
            }

        if (GMPVanillaSettings.CurrentSetting.farmFelcloth == 0 && wManager.wManagerSetting.CurrentSetting.DoNotSellList.Contains("Yellow Power Crystal"))
            {
            wManager.wManagerSetting.CurrentSetting.DoNotSellList.Remove("Yellow Power Crystal");
            }

        if (GMPVanillaSettings.CurrentSetting.farmFelcloth == 0 && wManager.wManagerSetting.CurrentSetting.DoNotSellList.Contains("Encrypted Twilight Text"))
            {
            wManager.wManagerSetting.CurrentSetting.DoNotSellList.Remove("Encrypted Twilight Text");
            }

        if (GMPVanillaSettings.CurrentSetting.farmFelcloth == 0 && wManager.wManagerSetting.CurrentSetting.DoNotSellList.Contains("Demonic Runes"))
            {
            wManager.wManagerSetting.CurrentSetting.DoNotSellList.Remove("Demonic Runes");
            }

        if (GMPVanillaSettings.CurrentSetting.farmFelcloth == 0 && wManager.wManagerSetting.CurrentSetting.DoNotSellList.Contains("Essence of Water"))
            {
            wManager.wManagerSetting.CurrentSetting.DoNotSellList.Remove("Essence of Water");
            }

        if (GMPVanillaSettings.CurrentSetting.farmFelcloth == 0 && wManager.wManagerSetting.CurrentSetting.DoNotSellList.Contains("Essence of Fire"))
            {
            wManager.wManagerSetting.CurrentSetting.DoNotSellList.Remove("Essence of Fire");
            }

        if (GMPVanillaSettings.CurrentSetting.farmFelcloth == 0 && wManager.wManagerSetting.CurrentSetting.DoNotSellList.Contains("Essence of Air"))
            {
            wManager.wManagerSetting.CurrentSetting.DoNotSellList.Remove("Essence of Air");
            }

        if (GMPVanillaSettings.CurrentSetting.farmFelcloth == 0 && wManager.wManagerSetting.CurrentSetting.DoNotSellList.Contains("Essence of Earth"))
            {
            wManager.wManagerSetting.CurrentSetting.DoNotSellList.Remove("Essence of Earth");
            }

        if (GMPVanillaSettings.CurrentSetting.farmFelcloth == 0 && wManager.wManagerSetting.CurrentSetting.DoNotSellList.Contains("Sungrass"))
            {
            wManager.wManagerSetting.CurrentSetting.DoNotSellList.Remove("Sungrass");
            }
...
public class GMPVanillaSettings : Settings
{
    public GMPVanillaSettings()
    {
        ...
        farmRawGold50 = 0;
        farmRawGold60 = 0;
		ungoroCrystalYellow = 0;
		ungoroCrystalBlue = 0;
		ungoroCrystalGreen = 0;
		ungoroCrystalRed = 0;
		twilight = 0;
		demonicRunes = 0;
        farmBOE60 = false;
	...
	// UngoroCrystals
    [Category("06) Ungoro Crystals")]
    [DisplayName("01) Red Power Crystal")]
    [Description("Requires: Character Level at 58 and position on Kalimdor")]
    public int ungoroCrystalRed { get; set; }

    [Category("06) Ungoro Crystals")]
    [DisplayName("02) Blue Power Crystal")]
    [Description("Requires: Character Level at 58 and position on Kalimdor")]
    public int ungoroCrystalBlue { get; set; }	
	
	[Category("06) Ungoro Crystals")]
    [DisplayName("03) Green Power Crystal")]
    [Description("Requires: Character Level at 58 and position on Kalimdor")]
    public int ungoroCrystalGreen { get; set; }
	
	[Category("06) Ungoro Crystals")]
    [DisplayName("04) Yellow Power Crystal")]
    [Description("Requires: Character Level at 58 and position on Kalimdor")]
    public int ungoroCrystalYellow { get; set; }
	
	[Category("07) Silithus Farms")]
    [DisplayName("01) Encrypted Twilight Text")]
    [Description("Requires: Character Level at 58 and position on Kalimdor")]
    public int twilight { get; set; }
	
    [Category("08) Other Farms")]
    [DisplayName("01) Demonic Runes")]
    [Description("Requires: Character Level at 59 and position on Kalimdor")]
    public int demonicRunes { get; set; }
	
    [Category("08) Other Farms")]
    [DisplayName("02) Essence of Water")]
    [Description("Requires: Character Level at 60 and position on Eastern Kingdoms")]
    public int farmEssenceWater { get; set; }

    [Category("08) Other Farms")]
    [DisplayName("03) Essence of Fire")]
    [Description("Requires: Character Level at 60 and position on Kalimdor")]
    public int farmEssenceFire { get; set; }

    [Category("08) Other Farms")]
    [DisplayName("04) Essence of Air")]
    [Description("Requires: Character Level at 60 and position on Kalimdor")]
    public int farmEssenceAir { get; set; }

    [Category("08) Other Farms")]
    [DisplayName("05) Essence of Earth")]
    [Description("Requires: Character Level at 60 and position on Kalimdor")]
    public int farmEssenceEarth { get; set; }


	// BOEs
    [Category("09) BOE Tasks BETA")]
